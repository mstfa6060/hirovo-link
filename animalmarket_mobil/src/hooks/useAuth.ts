...
export const useAuth = () => {
    ...
    const fetchAndSetUser = async () => {
        ...
        try {
            ...
            // const profile = await AnimalMarketAPI.DetailProfile.Detail.Request({ userId });
            console.log('Profile loading disabled in useAuth - API integration pending');
            // bucketId = profile.bucketId || '';
            bucketId = ''; // TODO: Get from actual profile
