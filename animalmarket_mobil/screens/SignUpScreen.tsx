...
const schema = z
    .object({
        ...
        providerId: z.string(),
        // userType: z.nativeEnum(IAMAPI.Enums.UserType), // TODO: Fix UserType enum
...
export default function SignUpScreen() {
    ...
    const {
        ...
        defaultValues: {
            ...
            confirmPassword: '',
            providerId: '',
            // userType: IAMAPI.Enums.UserType.Worker, // TODO: Fix UserType enum
    ...
    const onSubmit = async (data: FormData) => {
        try {
            ...
            if (userId) {
                // TODO: Replace with AnimalMarketAPI role assignment
                /*
                const roleResult = await AnimalMarketAPI.RelUserRoles.Create.Request({
                    userId,
        ...
        <SafeAreaView style={{ flex: 1, backgroundColor: '#f9f9f9' }}>
            ...
            >
                <ScrollView contentContainerStyle={{ padding: 16, paddingBottom: 100 }} keyboardShouldPersistTaps="handled">
                    ...
                    {/* TODO: Re-enable when UserType enum is fixed
